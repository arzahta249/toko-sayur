      ...
      {menu.map((category) => (
        ...
        >
          ...
          >
            ...
            <button
              className={`bg-${category.color} text-${category.color === "black" ? "white" : "black"} py-2 px-4 rounded-md transition-transform duration-300 transform hover:scale-105`}
            >
              Explore
            </button>
          </div>
